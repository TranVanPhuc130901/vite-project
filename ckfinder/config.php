...
$config['licenseName'] = 'localhost:5173';
...
// $uploadsURL = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]" . str_replace($_SERVER['DOCUMENT_ROOT'], '', $basePath . '/uploads/');

// echo $uploadsURL;
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/vite-project/uploads',
...
//     'name'         => 'default',
//     'adapter'      => 'cloudinary',
//     'cloud_name'   => 'dpnlgxwkp',
//     'api_key'      => '465287446555437',
//     'api_secret'   => 'PmpsYhnDs4TO_IFCj2m1XIW71nc',
//     'prefix'       => 'uploads/',
// );
